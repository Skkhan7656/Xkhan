...
\x1b[1;97m---------------------------------------------------
\x1b[1;97m[+] 𝗔𝗨𝗧𝗛𝗢𝗥  :   SKKHAN    
\x1b[1;97m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 :  XKKHAN
\x1b[1;97m[+] 𝗚𝗜𝗧𝗛𝗨𝗕  :   Skkhan7656
\x1b[1;97m[+] 𝗧𝗘𝗔𝗠    :   \33[1;42 Sk brand\33[0m
...
class Main:
	def __init__(self):
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/QiiNGx.XKKhaN.12327 ")
			print("")
			time.sleep(3.0)
			...
			time.sleep(3.1)
			print("")
			print("\033[1;32m ᗯᗴᒪᑕOᗰᗴ TO ••SKKHAN•• ᗷᖇᗩᑎᗪ TOOᒪՏ")
			time.sleep(3.0)
			os.system("clear")
		print(logo)
		print(" [+]𝗠𝗘𝗡𝗨  𝗠𝗘𝗧𝗛𝗢𝗗")
		...
		print(" \033[1;32m[4] 2006 ᴛᴏ 2014 ")
		print(" \33[1;32m[5] 2004 ᴛo 2010 ")
	...
	def old(self):
		...
		limit = int(input(" \n\033[0;95m[+]\033[0;93m TOTAL IDS TO CRACK LIMIT 10,000: "))
		try:
  ...
  "Mozilla/5.0 (Windows NT 5.1) AppleWebKit/53
